...
print(f'[ DEBUG ] INSTANCE_CONNECTION_NAME: {os.environ['INSTANCE_CONNECTION_NAME']}')
print(f'[ DEBUG ] DB_USER:                  {os.environ['DB_USER']}')
print(f'[ DEBUG ] DB_NAME:                  {os.environ['DB_NAME']}')
print(f'[ DEBUG ] DB_HOST:                  {os.environ['DB_HOST']}')
